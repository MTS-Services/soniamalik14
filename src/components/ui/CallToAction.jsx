      ...
      <Container>
        <div className={`relative rounded-2xl overflow-hidden ${bgColor}`}>
          <div className="grid lg:grid-cols-3 gap-8 items-center">
            {/* Left Content */}
            <div className={`px-12 lg:py-12 py-6 space-y-6 col-span-2 flex flex-col ${centered ? 'items-center' : 'items-center lg:items-start'} lg:max-w-2xl`}>
              ...
              <Button 
                ...
                className={`bg-white text-gray-900 hover:bg-gray-50 rounded-full px-6 py-2! gap-2 ${buttonClassName}`}
