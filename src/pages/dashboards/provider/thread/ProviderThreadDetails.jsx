...
const ProviderThreadDetails = () => {
    ...
    const replies = [
        { id: 1, author: thread.author, content: 'I usually train for 40–45 minutes a day, focusing on ball control and passing.' },
        ...
        <div className="dashboardPy dashboardSpaceY ">
            <div className="">
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm mb-6 sm:w-md">
                    ...
                    <p className="text-sm text-gray-600 leading-relaxed">{thread.description}</p>
                </div>
