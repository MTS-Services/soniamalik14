    ...
    <div className="dashboardPy dashboardSpaceY">
      <section className="rounded-lg bg-white">
        <div className="px-5 pt-5 pb-4">
          <h1 className="text-[36px] text-[#0B544E] leading-9 font-semibold ">Enquiries</h1>
        </div>

        <div className="space-y-3 p-4 md:hidden">
          {pageData.map((enquiry) => (
            <div key={enquiry.id} className="rounded-xl border border-[#E2E8EA] bg-[#F8FAFB] p-4">
        ...
        <div className="hidden overflow-x-auto md:block">
          <table className="min-w-245 border-collapse xl:min-w-full">
            <thead>
              <tr className="bg-[#EAF2F1] text-left border-b border-[#DCE7E6]">
            ...
            <tbody>
              {pageData.map((enquiry) => (
                <tr key={enquiry.id} className="border-b border-[#E8EEEE] last:border-b-0 align-middle">
      ...
      <section className="rounded-lg bg-white">
        ...
        <div className="hidden overflow-x-auto md:block">
          <table className="min-w-245 border-collapse xl:min-w-full">
            ...
            <tbody>
              {interestPageData.map((item) => (
                <tr key={item.id} className="border-b border-[#E8EEEE] last:border-b-0 align-middle">
