...
const AnalyticsCharts = ({ userFilter, onUserFilterChange }) => {
    return (
        <div className="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
            ...
            {/* Legend */}
            <div className="flex flex-wrap items-center gap-6 mb-8 text-sm font-medium text-gray-700">
                <div className="flex items-center gap-2">
                    <span className="w-2.5 h-2.5 rounded-full bg-[#2dd4bf]"></span>Player
                </div>
                <div className="flex items-center gap-2">
                    <span className="w-2.5 h-2.5 rounded-full bg-[#fde047]"></span>Service Provider
                </div>
                <div className="flex items-center gap-2">
                    <span className="w-2.5 h-2.5 rounded-full bg-[#111827]"></span>Sport Providers
                </div>
            </div>
