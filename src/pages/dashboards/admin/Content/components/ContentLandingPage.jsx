...
const ContentLandingPage = () => {
    return (
        <div className="space-y-8 font-sans pb-12">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">Explore Essa Hub</h2>
                
                {/* Section Inputs */}
                <div className="space-y-6 mb-10">
                    <div>
                        <label className="block text-sm font-medium text-gray-900 mb-2">Section Tittle</label>
                        <input 
                            type="text" 
                            placeholder="Write title" 
                            className="w-full bg-[#f5f5f5] border-none rounded-lg px-4 py-3.5 text-sm focus:ring-2 focus:ring-[#0f766e]/20 outline-none text-gray-800 placeholder-gray-500" 
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-900 mb-2">Section Subheadline</label>
                        <textarea 
                            placeholder="Write your subheadline" 
                            className="w-full h-32 bg-[#f5f5f5] border-none rounded-lg px-4 py-3.5 text-sm focus:ring-2 focus:ring-[#0f766e]/20 outline-none resize-none text-gray-800 placeholder-gray-500" 
                        />
                ...
                {/* Cards Area */}
                <h3 className="text-2xl font-bold text-gray-900 mb-6">Card</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="bg-[#f4f4f4] p-5 rounded-xl border border-gray-100">
                        <div className="space-y-5">
                            <div>
                                <label className="block text-sm font-medium text-gray-900 mb-2">Card Tittle</label>
                                <input 
                                    type="text" 
                                    placeholder="Write title" 
                                    className="w-full bg-white border border-gray-100 rounded-lg px-4 py-3 text-sm focus:ring-2 focus:ring-[#0f766e]/20 outline-none text-gray-800 placeholder-gray-500 shadow-sm" 
                                />
                            </div>
                            <div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">Find Your Sport</h2>
