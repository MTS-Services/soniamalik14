...
const Brands = () => {
    ...
    return (
        <div className="flex-1 min-h-screen overflow-auto bg-gray-50 p-6 md:p-8 font-sans">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="bg-[#f0f4f4] border-b border-gray-100">
                                    <th className="px-6 py-4 text-sm font-semibold text-gray-600 whitespace-nowrap">User Name</th>
                                    <th className="px-6 py-4 text-sm font-semibold text-gray-600 whitespace-nowrap">Phone number</th>
