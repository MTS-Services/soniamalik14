...
//                 <AlertCircle className="h-5 w-5 text-btn-primary" />
//               </div>
//             </div>
//             <div className="flex-1">
//               <h3 className="text-sm font-medium text-gray-900">{alert.sport} in {alert.location}</h3>
//               <p className="text-xs text-gray-500 mt-1">Demand {alert.demand} • Supply {alert.supply}</p>
//             </div>
//           </div>
//         ))}
//       </div>
