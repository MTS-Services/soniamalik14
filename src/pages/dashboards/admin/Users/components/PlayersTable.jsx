            ...
            <table className="w-full whitespace-nowrap">
                <thead className="bg-[#E7F1F1]">
                    <tr>
                        ...
                        <th className="px-4 py-3 text-left text-base font-medium text-gray-700">Events attended</th>
                        <th className="px-4 py-3 text-left text-base font-medium text-gray-700">Register interest</th>
