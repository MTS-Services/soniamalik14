...
//                     className={`px-5 py-2 rounded-md text-base font-medium transition ${activeTab === 'players' ? 'border border-[#91C0BC] text-gray-800 shadow-sm' : 'text-gray-500 hover:text-gray-700'}`}
//                 >
//                     Players
//                 </button>
//                 <button
//                     onClick={() => { setActiveTab('sportProviders'); setActiveSubTab('all'); }}
//                     className={`px-5 py-2 rounded-md text-base font-medium transition ${activeTab === 'sportProviders' ? 'border border-[#91C0BC] text-gray-800 shadow-sm' : 'text-gray-500 hover:text-gray-700'}`}
//                 >
//                     Sport Providers
//                 </button>
//                 <button
//                     onClick={() => { setActiveTab('serviceProviders'); setActiveSubTab('all'); }}
//                     className={`px-5 py-2 rounded-md text-base font-medium transition ${activeTab === 'serviceProviders' ? 'border border-[#91C0BC] text-gray-800 shadow-sm' : 'text-gray-500 hover:text-gray-700'}`}
//                 >
//                     Service Providers
//                 </button>
//             </div>
...
//                         className={`flex-1 pb-3 text-base font-medium text-center transition ${activeSubTab === 'all' ? 'text-[#117b73] border-b-2 border-[#117b73]' : 'text-gray-500 hover:text-gray-700'}`}
//                     >
