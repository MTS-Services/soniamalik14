            ...
            <div className="">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
                    <div>
                        ...
                        <p className="text-base text-gray-600 mt-2">Manage platform identities and permissions.</p>
                    </div>
                    <button className="flex items-center gap-2 px-6 py-4 bg-btn-primary text-white font-medium rounded-lg hover:bg-teal-700 transition-colors">
