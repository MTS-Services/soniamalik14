...
//                 <div className="bg-[#E7F1F1] p-4 rounded-xl flex flex-col lg:flex-row items-stretch lg:items-center gap-3 mb-8 max-w-4xl">
...
//                         <button className="bg-[#0F766E] text-white px-6 py-3 rounded-lg text-base font-semibold shadow-sm hover:bg-[#0F635A] transition-colors flex-1 sm:flex-none">
//                             Shop Brands
//                         </button>

//                         <button disabled className="bg-[#91C0BC] text-black px-5 py-1.5 rounded-lg flex flex-col text-base items-center justify-center flex-1 sm:flex-none">
...
//                         <button disabled className="bg-[#91C0BC] text-black px-5 py-1.5 rounded-lg text-base flex flex-col items-center justify-center flex-1 sm:flex-none">
