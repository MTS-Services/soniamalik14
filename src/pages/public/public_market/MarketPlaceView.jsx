...
const MarketPlaceView = () => {
  ...
  return (
    <section >
      <Container className="py-6 lg:py-8 bg-[#F8FAFC]   font-sans">
        {/* Header Title */}
        <div className="mb-6">
        ...
        <div className="bg-[#F0F5F4] p-3 rounded-xl flex flex-col lg:flex-row items-stretch lg:items-center gap-3 mb-12">
