      ...
      <Container>
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <button onClick={() => navigate(-1)} className="flex items-center gap-2 text-sm text-[#0F766E] mb-4">
            ...
            <div className="flex flex-col md:flex-row md:items-start gap-6">
              ...
              <div>
                ...
                <div className="text-sm text-[#626262] mt-2">{item.type} • {item.location}</div>

                <div className="mt-6 text-sm text-[#626262] leading-relaxed">
