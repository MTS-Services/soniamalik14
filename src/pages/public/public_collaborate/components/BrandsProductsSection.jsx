...
//             <div className="absolute inset-0 md:w-[80%] h-full md:left-auto md:right-0">
//                 <img
...
//             {/* Gradient Overlay (Fades Left to Right) */}
//             <div
...
//             <div className="relative z-10 w-full md:w-[55%] lg:w-[50%] p-6 sm:p-10 lg:p-16 flex flex-col justify-end md:justify-center min-h-[450px] md:min-h-0 h-full mr-auto">
    ...
    return (
        <div className="relative w-full rounded-lg overflow-hidden bg-white shadow-sm flex flex-col md:block">
            ...
            <div className="relative z-10 p-6 sm:p-10 md:p-12 lg:p-16 w-full md:w-[65%] lg:w-[55%] bg-white md:bg-transparent min-h-[450px] md:min-h-[500px] xl:min-h-[550px] flex flex-col justify-center">
                ...
                <h2 className="text-3xl md:text-[32px] leading-tight font-medium text-gray-900 mb-5 tracking-tight">
                    For Brands & Products
                </h2>
