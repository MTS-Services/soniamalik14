                        ...
                        <div className="flex flex-wrap gap-2">
                            {sports.map((sport) => (
                                <button
                                    ...
                                    className={`px-3 py-1 rounded-full text-sm font-medium transition-colors ${selectedSport === sport
                        ...
                        <div className="flex flex-wrap gap-2">
                            {topics.map((topic) => (
                                <button
                                    ...
                                    className={`px-3 py-1 rounded-full text-sm font-medium transition-colors ${selectedTopics.includes(topic)
                                            ? 'bg-btn-primary text-white'
                                            : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
                                        }`}
                                >
